...
router-link和router-view可以不在同一个vue页面上
...
> 存放vuex中state的值 要用computed 不用data
>
> vuex中的值改变了 data不会跟着变 因为data内容依赖变化时 data不会跟着变
>
> 而computed会依赖追踪，他依赖的vuex数据变了 computed会跟着变，所以要用computed
>
>
>
> https://blog.csdn.net/wopelo/article/details/80244049
